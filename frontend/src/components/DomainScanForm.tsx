...
import { runFullScan, serializeReconData, type ReconData } from '../services/reconApi';
...
export function DomainScanForm({ onScanComplete, isScanning, setIsScanning }: DomainScanFormProps) {
