...
export class Backend implements backendInterface {
    ...
    async getScan(arg0: string): Promise<ScanResult> {
    ...
    async getScanHistory(): Promise<Array<[string, Time]>> {
        if (this.processError) {
            try {
    ...
    async saveScan(arg0: string, arg1: Array<string>, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveScan(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
