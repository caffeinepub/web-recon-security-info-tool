        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-cyber-green-dim">
                ://
              </span>
            </div>
            <h2 className="font-mono text-lg font-bold text-cyber-green neon-text-green">
              {domain}
            </h2>
          </div>
          {hasErrors && (
            ...
            {[
              ...
              >
                ...
                {tab.count !== null && tab.count > 0 && (
                  <span className="text-[10px] text-cyber-green-dim">
                    {tab.count}
                  </span>
                )}
              </TabsTrigger>
